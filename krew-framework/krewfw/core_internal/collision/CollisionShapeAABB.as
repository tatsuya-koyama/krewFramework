package krewfw.core_internal.collision {
    ...
    //------------------------------------------------------------
    public class CollisionShapeAABB extends CollisionShape {
        ...
        //------------------------------------------------------------
        public function CollisionShapeAABB(owner:KrewActor, handler:Function,
                                             width:Number, height:Number,
                                             offsetX:Number=0, offsetY:Number=0) {
            super(owner, handler, offsetX, offsetY);
            _type = CollisionShape.SHAPE_AABB;
