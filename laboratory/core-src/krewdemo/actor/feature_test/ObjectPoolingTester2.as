package krewdemo.actor.feature_test {
    ...
    //------------------------------------------------------------
    public class ObjectPoolingTester2 extends KrewActor {
        ...
        public override function init():void {
            ...
            addPeriodicTask(0.01, function():void {
                ...
                for (var i:int=0;  i < 5;  ++i) {
                    ...
                    createActor(StarParticlePooled.getObject(depth, color));
                    ++_generateCount;
                }
            });
        }
        ...
        public override function onUpdate(passedTime:Number):void {
            _textField.text = "     generate: " + _generateCount + "\n"
                            + "    new count: " + StarParticlePooled.numCreate + "\n"
                            + "num on screen: " + StarParticlePooled.numExists + "\n"
                            + "       pooled: " + StarParticlePooled.numPooled;
        }
